...
from hydrolibcore.basemodel import BaseModel, FileModel, ParsableFileModel
...
class DIMR(ParsableFileModel):
    ...
    Attributes:
        ...
        control (List[Union[Start, Parallel]]): The `<control>` element with a list
            of [Start][hydrolibcore.io.dimr.models.Start]
            and [Parallel][hydrolibcore.io.dimr.models.Parallel] sub-elements,
