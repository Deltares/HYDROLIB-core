...
from hydrolibcore.basemodel import BaseModel
from hydrolibcore.io.dflowfm.ini.io_models import Property, Section
from hydrolibcore.io.dflowfm.ini.models import (
...
from hydrolibcore.utils import to_list
...
class ForcingBase(DataBlockINIBasedModel):
    ...
    [ForcingModel][hydrolibcore.io.dflowfm.bc.models.ForcingModel]`.forcing[..]`.
    """
...
class ForcingModel(INIModel):
    ...
    This model is for example referenced under a
    [ExtModel][hydrolibcore.io.dflowfm.ext.models.ExtModel]`.boundary[..].forcingfile[..]`.
    """
    ...
    forcing[..].datablock from [hydrolibcore.io.dflowfm.ini.models.DataBlockINIBasedModel.datablock]."""
