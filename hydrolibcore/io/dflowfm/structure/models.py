"""
structure namespace for storing the contents of an [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]'s structure file.
"""
...
from hydrolibcore.utils import str_is_empty_or_none
...
class Weir(Structure):
    ...
    Typically inside the structure list of a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.structurefile[0].structure[..]`
...
class CulvertSubType(str, Enum):
    """Enum class to store a [Culvert][hydrolibcore.io.dflowfm.structure.models.Culvert]'s subType."""
...
class StructureModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.structurefile[..]`.
