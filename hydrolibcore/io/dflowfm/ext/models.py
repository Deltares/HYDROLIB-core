...
from hydrolibcore.io.dflowfm.bc.models import ForcingBase, ForcingData, ForcingModel
...
class Boundary(INIBasedModel):
    ...
    i.e., a [ExtModel][hydrolibcore.io.dflowfm.ext.models.ExtModel].
...
class ExtModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.external_forcing.extforcefilenew`.
