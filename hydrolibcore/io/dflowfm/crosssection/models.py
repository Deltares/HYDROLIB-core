...
from hydrolibcore.io.dflowfm.ini.util import (
...
class CrossSectionDefinition(INIBasedModel):
    ...
    i.e., a [CrossDefModel][hydrolibcore.io.dflowfm.crosssection.models.CrossDefModel].
...
class CrossDefModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.crossdeffile`.
...
class CircleCrsDef(CrossSectionDefinition):
    ...
    Typically inside the definition list of a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.crossdeffile.definition[..]`
...
class CrossSection(INIBasedModel):
    ...
    i.e., a [CrossLocModel][hydrolibcore.io.dflowfm.crosssection.models.CrossLocModel].
...
class CrossLocModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.crosslocfile`.
