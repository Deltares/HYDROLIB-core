...
from hydrolibcore.io.dflowfm.common.models import LocationType
...
class ObservationPointModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.output.obsfile[..]`.
