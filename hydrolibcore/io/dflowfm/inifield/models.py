...
class InitialField(AbstractSpatialField):
    ...
    an inifield file.
    Typically inside the definition list of a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.inifieldfile.initial[..]`
    """
...
class ParameterField(AbstractSpatialField):
    ...
    an inifield file.
    Typically inside the definition list of a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.inifieldfile.parameter[..]`
    """
...
class IniFieldModel(INIModel):
    ...
    This model is typically referenced under a [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]`.geometry.inifieldfile[..]`.
