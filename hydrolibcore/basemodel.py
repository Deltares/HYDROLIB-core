...
from hydrolibcore.io.base import DummmyParser, DummySerializer
from hydrolibcore.utils import (
    OperatingSystem,
...
class FileModel(BaseModel, ABC):
    ...
    def _get_relative_mode_from_data(cls, data: Dict[str, Any]) -> ResolveRelativeMode:
        ...
        dependent on the state (e.g. the [FMModel][hydrolibcore.io.dflowfm.mdu.models.FMModel]).
...
class DiskOnlyFileModel(FileModel):
    ...
    models which are not explicitly implemented within hydrolibcore.
