...
class TestParser:
    ...
    def test_is_comment(self, input_string: str, expected_value: bool):
    ...
    def test_convert_to_comment(self, input_string: str, expected_value: str):
    ...
    def test_is_name(self, input_string: str, expected_value: bool):
    ...
    def test_convert_to_name(self, input_string: str, expected_value: str):
