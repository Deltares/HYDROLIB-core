from hydrolib.core.io.structure.models import FlowDirection, PropertyField, Weir
...
def test_weir_with_unknown_parameters():
    ...
    assert weir.unknown_properties == [
        PropertyField(
            key="unknown",
            value="10.0",
            comment=" A deliberately added unknown property",
        )
    ]
