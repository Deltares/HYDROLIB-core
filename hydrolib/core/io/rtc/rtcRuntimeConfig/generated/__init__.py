...
class ExternalIntegerSimpleTypeItem(ExternalBooleanSimpleTypeItem):
    pass
...
class IPOPTNLPComplexType(RtcBaseModel):
    ...
    check_derivatives_for_naninf: Optional[DerivativeTestPrintAll] = Field(
        None,
    ...
    honor_original_bounds: Optional[DerivativeTestPrintAll] = Field(
        None,
        description='Indicates whether final points should be projected into original bounds [no/yes]',
    )
    jac_c_constant: Optional[DerivativeTestPrintAll] = Field(
        None,
        description='Indicates whether all equality constraints are linear [no/yes]',
    )
    jac_d_constant: Optional[DerivativeTestPrintAll] = Field(
        None,
...
class IPOPTOutputComplexType(RtcBaseModel):
    ...
    print_options_documentation: Optional[DerivativeTestPrintAll] = Field(
        None, description='Switch to print all algorithmic options [no/yes]'
    )
    print_timing_statistics: Optional[DerivativeTestPrintAll] = Field(
        None, description='Switch to print timing statistics [no/yes]'
    )
    print_user_options: Optional[DerivativeTestPrintAll] = Field(
...
class FileObjectiveComplexType(FileDataComplexType):
    pass
...
class FileToolsComplexType(FileDataComplexType):
    pass
...
class IPOPTLineSearchComplexType(RtcBaseModel):
    ...
    accept_every_trial_step: Optional[MehrotraAlgorithm] = Field(
        None,
...
class IPOPTMultiplierUpdatesComplexType(RtcBaseModel):
    ...
    recalc_y: Optional[MehrotraAlgorithm] = Field(
        None,
...
class IPOPTRestorationPhaseComplexType(RtcBaseModel):
    ...
    evaluate_orig_obj_at_resto_trial: Optional[MehrotraAlgorithm] = Field(
        None,
    ...
    expect_infeasible_problem: Optional[MehrotraAlgorithm] = Field(
        None,
    ...
    start_with_resto: Optional[MehrotraAlgorithm] = Field(
        None,
...
class IPOPTWarmStartComplexType(RtcBaseModel):
    ...
    warm_start_init_point: Optional[MehrotraAlgorithm] = Field(
        None,
...
class MA57ComplexType(RtcBaseModel):
    ...
    ma57_automatic_scaling: Optional[DerivativeTestPrintAll] = Field(
        None,
...
class MA97ComplexType(RtcBaseModel):
    ...
    ma97_scaling2: Optional[Ma97Scaling1] = Field(
        None,
    ...
    ma97_scaling3: Optional[Ma97Scaling1] = Field(
        None,
    ...
    ma97_solve_blas3: Optional[MehrotraAlgorithm] = Field(
        None,
    ...
    ma97_switch2: Optional[Ma97Switch1] = Field(
        None,
    ...
    ma97_switch3: Optional[Ma97Switch1] = Field(
        None,
...
class IPOPTLinearSolverComplexType(RtcBaseModel):
    ...
    linear_scaling_on_demand: Optional[DerivativeTestPrintAll] = Field(
        None,
