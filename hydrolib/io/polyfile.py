...
class Parser:
    ...
    def finalise(self) -> Tuple[Sequence[PolyObject], 
                                Sequence[ParseMsg], 
                                Sequence[ParseMsg]]:
    ...
    def _finish_block(self):
        self._poly_objects.append(PolyObject(
    ...
    def _add_current_block_as_incomplete_error(self) -> None:
        self._errors.append(ParseMsg(line=(self._current_block.start_line, self.line), 
    ...
    def _parse_next_point(self, line: str) -> None:
        point = Parser._convert_to_point(
            line, 
            self._current_block.dimensions[1], # type: ignore
            self._has_z_value)
    ...
    def _handle_new_description(self, line: str) -> None:
        ...
        self._current_block.description = [ comment, ]
    ...
    @staticmethod
    def _convert_to_point(line: str, expected_n_points: int, has_z: bool) -> Optional[Point]:
        stripped = line.strip()
        elems = stripped.split()
